...
const Features = () => {
    return (
        <section id="features" className="bg-[#141e19] py-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
                    ...
                    <div className="flex flex-col items-center text-center lg:items-start lg:text-left gap-8">
                        <div>
                            <h2 className="text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl">
                                O Sabor Autêntico do <br className="lg:hidden" /><span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-yellow-200">Chopp Ecobier</span>
                            </h2>
                    ...
                    <div className="relative mx-auto w-full max-w-xs sm:max-w-md lg:max-w-none">
                        <div className="relative flex aspect-square sm:aspect-auto items-center justify-center rounded-full bg-gradient-to-tr from-primary/10 to-transparent lg:aspect-[4/3] lg:rounded-3xl lg:bg-none">
