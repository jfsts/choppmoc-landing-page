            ...
            <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <div className="hidden lg:flex items-center gap-1">
                    {navLinks.map((link) => (
                        ...
                        >
                            {link.label}
                            <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-linear-to-r from-emerald-500 to-amber-500 transition-all duration-300 group-hover:w-3/4 rounded-full" />
                ...
                <div className="hidden lg:flex items-center gap-4">
                    ...
                    <a
                        ...
                        className="relative group overflow-hidden rounded-full bg-linear-to-r from-amber-500 to-amber-400 px-6 py-2.5 text-sm font-bold text-stone-900 shadow-[0_0_20px_rgba(245,158,11,0.3)] transition-all duration-300 hover:shadow-[0_0_40px_rgba(245,158,11,0.5)] hover:-translate-y-0.5"
                    >
                        <span className="relative z-10 flex items-center gap-2">
                            <MessageCircle className="w-4 h-4" />
                            Pedir Chopp
                        </span>
                        <span className="absolute inset-0 bg-linear-to-r from-amber-400 to-yellow-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                    </a>
                </div>
            ...
            <div className={`lg:hidden absolute top-full left-0 right-0 transition-all duration-500 ${isMobileMenuOpen
                ...
                <div className="bg-[#0a0f0c]/95 backdrop-blur-3xl border-t border-emerald-500/10 p-6 shadow-2xl">
                    <div className="flex flex-col gap-2">
                        {navLinks.map((link) => (
                            ...
                            >
                                ...
                                <span className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-0 bg-linear-to-b from-emerald-500 to-amber-500 transition-all duration-300 group-hover:h-1/2 rounded-full" />
                            </a>
                        ))}
                    </div>
                    <div className="mt-6 pt-6 border-t border-white/10">
                        <a
                            href="https://wa.me/5538998606066?text=Olá,%20gostaria%20de%20um%20orçamento%20para%20Chopp!"
                            className="flex items-center justify-center gap-2 rounded-full bg-linear-to-r from-amber-500 to-amber-400 px-6 py-3 text-center font-bold text-stone-900 shadow-lg"
